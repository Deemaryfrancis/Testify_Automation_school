...
#Optionally instantiate the Car and Plane method, then
# invoke the drive_direction() in each of the object instances.
...
class Car(Vehicle):
    def drive_direction(self):
        return "Drives forward"

class Plane(Vehicle):
    def drive_direction(self):
        return "Drives Upward"
